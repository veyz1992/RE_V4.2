                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-4 bg-gray-light rounded-lg border border-gray-border space-y-4">
                                ...
                                <div>
                                    ...
                                    {/* FIX: Cast select value to the correct type to resolve TypeScript error. */}
                                    <select value={formData.badgeStatus} onChange={e => setFormData({...formData, badgeStatus: e.target.value as NonNullable<AdminMember['badge']>['status']})} className="w-full mt-1 p-2 border rounded-md">
