...
export const ADMIN_SUBSCRIPTIONS: AdminSubscription[] = [
  ...
  {
    id: "sub_002", memberId: "mem_003", businessName: "Coastal Recovery Inc.", tier: "Silver", planPrice: 229, billingCycle: "Monthly",
    status: "Past due", nextPaymentDate: "2025-02-10", lastPaymentDate: "2025-01-10", mrr: 229,
    stripeCustomerId: "cus_def456", stripeSubscriptionId: "sub_def456",
    churnRisk: "High",
    flagged: false,
    invoices: [
        { id: "inv_2a", date: "2025-02-10", amount: 229, status: "Failed" },
        { id: "inv_2b", date: "2025-01-10", amount: 229, status: "Paid" },
    ],
  },
  {
  ...
  {
    id: "sub_004", memberId: "mem_006", businessName: "Midwest Damage Repair", tier: "Silver", planPrice: 229, billingCycle: "Monthly",
    ...
    churnRisk: "High",
    invoices: [
        { id: "inv_4a", date: "2025-01-05", amount: 229, status: "Paid" },
    ],
  },
  {
...
export const PRICING_PACKAGES: PricingPackage[] = [
    ...
    { id: 'silver', name: 'Silver', price: 229, features: ['Everything in Bronze', 'Featured placement', 'Enhanced profile', 'Yearly SEO blog post'] },
