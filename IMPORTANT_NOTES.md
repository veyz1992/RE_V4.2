...
### 🔧 Environment & Function Audit - December 2024:

**Added SUPABASE_URL (server-side) requirement for Netlify Functions.**

**get-success-summary now resolves profile/name via Stripe metadata → assessments/profiles.**
